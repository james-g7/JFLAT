...
public class FinalStatePushdownAutomataCanvas extends AbstractAutomatonCanvas<FinalStatePushdownState, FinalStatePushdownAutomataTransition, FinalStatePushdownAutomata> {
    ...
    @Override
    protected FinalStatePushdownState instantiateState(int x, int y, String name) {
        return new FinalStatePushdownState(name, x, y, false);
    }

    @Override
    protected FinalStatePushdownState copyState(FinalStatePushdownState original) {
        return new FinalStatePushdownState(original.getName(), original.x, original.y, original.isFinal());
    }
    ...
    @Override
    protected boolean isStateFinal(FinalStatePushdownState state) {
        return state.isFinal();
    }

    @Override
    protected void addContextMenuExtras(JPopupMenu popup, FinalStatePushdownState state) {
